...
class EvaluatorAgent {
    constructor(promptOrchestrator, modelRouter) {
     ...
     */
    async evaluateResult(result, originalTask) {
        ...
        const evalModel = await this.modelRouter.routeToModel({ ...originalTask, complexity: 'medium' }, // Use medium for evaluation
     ...
     */
    async assessQuality(result, evalPrompt) {
     ...
     */
    async buildEvaluationPrompt(result, originalTask, model) {
